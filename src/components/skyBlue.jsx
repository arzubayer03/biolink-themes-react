...
function SkyBlue() {
  ...
  return (
     <div className="h-full w-full max-w-sm bg-skyblue bg-cover bg-center flex flex-col rounded-xl relative scrollbar-hide ">
              ...
              const link = Links[key];
                return (
                    <div key={link.id} className="mb-2">
                      ...
                      <a href={link.url} className="block bg-orange-500 text-black text-center py-2 rounded">
                        {link.name}
                      </a>
                    </div>
                  );
