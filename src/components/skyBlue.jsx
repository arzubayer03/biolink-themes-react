import pPic from "./img/profilePic2.png";
...
function SkyBlue() {
  return (
    <section class=" flex items-center justify-center">
        <div
          class="h-96 w-44 flex flex-col justify-between bg-theme2-bg bg-cover bg-center rounded-2xl relative"
        >
          <button
          ...
          <div class="flex flex-col items-center">
            ...
            <div class="mt-1 text-center">
              <h1 class="font-semibold text-base">Eliana D’cruz</h1>
          ...
          <div class="px-2 w-full flex flex-col space-y-1 text-xs">
            <a
              href=""
              class="text-black bg-orange-600 rounded-lg py-2 flex justify-center items-center"
              >Future Events</a>
            <a
              href=""
              class="text-black bg-orange-600 rounded-lg py-2 flex justify-center items-center"
          ...
          <div class="space-y-1 py-2">
            <div class="flex justify-center">
              <div class="bg-gradient-to-l from-orange-600  h-px w-20"></div>
              <div class="bg-gradient-to-r from-orange-600  h-px w-20"></div>
            </div>
            <div class="flex justify-center items-center space-x-2">
              <img src={logo} class="size-4" />
