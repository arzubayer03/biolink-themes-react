...
const profilePic = 'https://images.pexels.com/photos/2787341/pexels-photo-2787341.jpeg?auto=compress&cs=tinysrgb&w=600';
const coverPhoto = " https://images.pexels.com/photos/67857/daisy-flower-spring-marguerite-67857.jpeg?auto=compress&cs=tinysrgb&w=600" ;

function SkyBlue() {
  return (
     <div className="h-full w-full max-w-sm bg-skyblue bg-cover bg-center flex flex-col rounded-2xl relative scrollbar-hide ">
      ...
      <div className="overflow-y-auto scrollbar-hide  h-full"> 
        ...
        <div className="mt-4 mb-10 px-4 ">
          ...
          <div className="">
              ...
              <a href="#" className="block bg-orange-500 text-black text-center py-2 rounded mb-2">Future Events</a>
          </div>

          <div className="">
              <h3 className="text-black text-center font-semibold mb-1">Read my latest blog</h3>
              <a href="#" className="block bg-orange-500 text-black text-center py-2 rounded mb-2">Blog link</a>
          </div>

          <div className="">
              <h3 className="text-black text-center"></h3>
              <a href="#" className="block bg-orange-500 text-black text-center py-2 rounded mb-2">🌐🔗Visit my shop</a>
          </div>

          <div className="">
              <h3 className="text-black text-center"></h3>
              <a href="#" className="block bg-orange-500 text-black text-center py-2 rounded mb-2">My facebook page</a>
          </div>
        </div>
      </div>
