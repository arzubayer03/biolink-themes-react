...
function Desert() {
  return (
     <div className="h-full w-full max-w-sm bg-desert bg-cover bg-center flex flex-col rounded-2xl relative scrollbar-hide ">
          ...
          <div className=" px-4 overflow-y-auto scrollbar-hide  h-full"> 
            ...
            <div className="mt-4 mb-2  ">
              ...
              <div className="">
                  ...
                  <a href="#" className="block bg-black/75 text-white text-center py-2 rounded mb-2">Future Events</a>
              </div>
    
              <div className="">
                  <h3 className="text-black text-center font-semibold mb-1">Read my latest blog</h3>
                  <a href="#" className="block bg-black/75 text-white text-center py-2 rounded mb-2">Blog link</a>
              </div>
    
              <div className="">
                  <h3 className="text-black text-center"></h3>
                  <a href="#" className="block bg-black/75 text-white text-center py-2 rounded mb-2">🌐🔗Visit my shop</a>
              </div>
    
              <div className="">
                  <h3 className="text-black text-center"></h3>
                  <a href="#" className="block bg-black/75 text-white text-center py-2 rounded mb-2">My facebook page</a>
              </div>
            </div>
          </div>
