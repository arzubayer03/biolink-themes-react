...
function Minimal() {
  return (
     <div className="h-full w-full max-w-sm  bg-teal-500  bg-cover bg-center flex flex-col rounded-2xl relative scrollbar-hide ">
          <div className="absolute top-4 right-4 z-10">
            ...
            <div className="text-center mt-2 mb-1">
              <h2 className="text-white text-xl font-semibold">David Tutera</h2>
            </div>
          ...
          <div className="px-4 overflow-y-auto scrollbar-hide  h-full"> 
            ...
            <div className="mt-4 mb-2 ">
              ...
              <div className="">
                  ...
                  <a href="#" className="block bg-red-primary text-white text-center py-2 rounded mb-2">Future Events</a>
              </div>
    
              <div className="">
                  <h3 className="text-black text-center font-semibold mb-1">Read my latest blog</h3>
                  <a href="#" className="block bg-green-primary text-white text-center py-2 rounded mb-2">Blog link</a>
              </div>
    
              <div className="">
                  <h3 className="text-black text-center"></h3>
                  <a href="#" className="block bg-purple-primary text-white text-center py-2 rounded mb-2">🌐🔗Visit my shop</a>
              </div>
    
              <div className="">
                  <h3 className="text-black text-center"></h3>
                  <a href="#" className="block bg-yellow-primary text-white text-center py-2 rounded mb-2">My facebook page</a>
              </div>
            </div>  
